...
const HITS = [
  ...
  { id:4,  name:"steamed sea bass", components:["sea bass","ginger + scallion","jasmine rice"], cuisine:"cantonese", time:25,
    recipe:"Start jasmine rice. Steam sea bass with sliced ginger 8-10 min until just opaque. Heat sesame oil until smoking, pour directly over fish with soy sauce â it crackles and perfumes everything. Serve over rice." },
  ...
  { id:6,  name:"salmon with asparagus", components:["salmon","asparagus","lemon + fleur de sel"], cuisine:"simple", time:20,
    recipe:"Season salmon. Sear skin-side down 4 min. Flip, add asparagus to pan, transfer to 400Â°F oven 6-8 min. Rest 2 min. Finish asparagus with lemon and fleur de sel." },
  { id:7,  name:"japanese curry with kabocha", components:["chicken thighs","potato + kabocha","japanese curry roux"], cuisine:"japanese", time:35,
    recipe:"SautÃ© chicken until golden. Add potato and kabocha chunks and water to cover. Simmer 15 min. Reduce heat, add curry roux blocks, stir until dissolved. Simmer 5 more min until thick. Kabocha sweetens the whole dish. Serve over jasmine rice." },
  ...
  { id:18, name:"teriyaki wings with honey finish", components:["chicken wing flats","teriyaki + honey glaze","sesame + scallion"], cuisine:"japanese", time:35,
    recipe:"Pat flats completely dry. Arrange on a wire rack over a foil-lined sheet pan â rack is essential. Roast at 425Â°F 25-30 min turning once. Brush generously with teriyaki mixed with a touch of honey. Broil on high 3-4 min until lacquered. Watch closely. Finish with sesame seeds and scallion." },
];
...
const NEW_MEALS = [
  ...
  { id:10, name:"oyakodon", components:["chicken thighs","egg","dashi rice"], cuisine:"japanese", time:20, isNew:true,
    recipe:"Make dashi (1 cup water + 1 dashi packet). Add 2 tbsp soy sauce, 2 tbsp mirin, 1 tbsp sake. Simmer sliced chicken 5 min. Pour beaten eggs over, cover 1 min until just set â leave slightly runny. Slide over steamed rice. Top with scallion." },
  ...
  { id:12, name:"ginger scallion fish", components:["sea bass","fresh ginger","sizzling scallion oil"], cuisine:"cantonese", time:25, isNew:true,
    recipe:"Steam sea bass 8-10 min. Julienne scallions and ginger, pile on top of fish. Heat 3 tbsp neutral oil + 1 tbsp sesame oil until smoking. Pour sizzling over fish and scallions â it crackles. Finish with soy sauce." },
  ...
  { id:15, name:"braised pork belly rice", components:["pork belly","soy mirin glaze","steamed rice"], cuisine:"japanese", time:40, isNew:true,
    recipe:"Score pork belly skin and sear all sides until golden. Remove. In same pan: Â¼ cup soy, Â¼ cup mirin, 2 tbsp sake, 1 tbsp sugar, 1 cup water. Return pork, cover and braise on low 30 min. Slice and serve over rice with braising liquid. Top with scallion." },
  { id:16, name:"shrimp provenÃ§al", components:["shrimp","cherry tomatoes + herbs de provence","white wine"], cuisine:"french", time:20, isNew:true,
    recipe:"SautÃ© 3 garlic cloves in olive oil. Add cherry tomatoes, generous pinch of herbs de provence, salt and pepper. Cook until tomatoes burst, 5 min. Add shrimp and white wine, cook 2-3 min per side. Finish with parsley and lemon. Serve with crusty bread or over orzo." },
  { id:19, name:"black cod miso", components:["black cod","white miso + mirin glaze","steamed bok choy"], cuisine:"japanese", time:30, isNew:true,
    recipe:"Mix 3 tbsp white miso, 2 tbsp mirin, 1 tbsp sake, 1 tbsp sugar. Marinate black cod 2-24 hours â longer is better. Wipe off excess marinade before cooking. Broil on high 10-12 min until deeply caramelized. The fish is rich and buttery, the glaze is everything. Serve with steamed bok choy over rice." },
  { id:20, name:"seared scallops", components:["hokkaido scallops","brown butter + lemon","haricots verts"], cuisine:"french", time:15, isNew:true,
    recipe:"Pat scallops completely dry â essential. Season with salt. Sear in very hot neutral oil without moving 2 min until deep golden crust forms. Flip, cook 1 min. Remove. In same pan make brown butter â swirl until nutty and amber. Add lemon juice off heat. Pour over scallops. Serve immediately over blanched haricots verts." },
  { id:21, name:"monkfish with caper butter", components:["monkfish","brown butter + capers + lemon","asparagus"], cuisine:"french", time:25, isNew:true,
    recipe:"Remove the grey membrane from monkfish â peel with a sharp knife or it will tighten when cooked. Season and sear in butter and oil 4 min per side until golden. Rest. In same pan make brown butter with capers and lemon juice. Pour over fish. Serve alongside roasted asparagus." },
...
// âââ INSPIRATION RECIPES â "WHOA FACTOR" âââââââââââââââââââââââââââââââââââââ
...
const INSPIRATION = [
  ...
  },
  {
    ...
    source:"Adapted from NYT Cooking â Melissa Clark",
    components:["chicken thighs","castelvetrano olives + lemon","fresh thyme"],
    recipe:"Season chicken thighs well. Sear skin-side down in an oven-safe pan until deeply golden, 8 min. Flip. Scatter castelvetrano olives, lemon slices, and fresh thyme around the chicken. Transfer to 425Â°F oven 20 min until cooked through. The olives and lemon become a sauce in the pan juices. Spoon everything over the chicken to serve. Castelvetrano olives are the key â buttery and mild, not briny.",
    grad:"linear-gradient(135deg,#9b8ec4,#8070b0)"
  },
  {
    id:"i4", tag:"nyt adaptation", cuisine:"japanese", time:20,
    name:"miso butter pasta",
    why:"your miso linguine instinct formalized. this is the nyt version â miso and butter is one of the great flavor discoveries of the last decade.",
    source:"Adapted from NYT Cooking",
    components:["spaghetti","white miso + butter","parmigiano + black pepper"],
    recipe:"Cook pasta. In a pan, melt 3 tbsp butter. Whisk in 2 tbsp white miso until combined. Add Â½ cup pasta water and simmer until slightly reduced. Toss in drained pasta. Off heat, add a generous handful of parmigiano and toss until creamy. Finish with coarsely cracked black pepper. The miso gives it umami depth that parm alone can't â it tastes like the best version of carbonara you've never had.",
  ...
  },
  {
    ...
    why:"the simplest dish in this entire app. no cooking, three condiments, five minutes. the quality of the tofu is everything â this is why you go to hong kong supermarket.",
    source:"Classic Cantonese preparation",
    components:["silken tofu","soy sauce + sesame oil + ginger","scallion"],
    recipe:"Slide silken tofu carefully onto a plate â do not break it. Mix 2 tbsp soy sauce, 1 tsp sesame oil, 1 tsp freshly grated ginger, pinch of sugar. Pour over tofu. Top with thinly sliced scallion. Heat 1 tbsp neutral oil until shimmering, pour over the scallion â it will sizzle and wilt. Eat immediately with rice. That's the whole recipe.",
  ...
  },
  {
    ...
    why:"four ingredients. one technique â browning butter until nutty. the smell alone is a revelation.",
    source:"Adapted from NYT Cooking",
    components:["pappardelle or rigatoni","brown butter","fresh sage + parmigiano"],
    recipe:"Cook pasta. In a wide pan, melt 4 tbsp butter over medium heat and keep cooking, swirling, until it turns deep golden and smells nutty â about 4 min. Add 8-10 fresh sage leaves (they'll crisp immediately). Add Â½ cup pasta water and swirl to emulsify. Add drained pasta and toss. Off heat, add generous parmigiano. Finish with fleur de sel. The browned butter is a different ingredient than regular butter â the nutty depth is extraordinary.",
    grad:"linear-gradient(135deg,#c9a87c,#b89068)"
  },
  {
    ...
    recipe:"Bring water to boil. Lower eggs gently, cook exactly 7 min. Transfer immediately to ice water, peel carefully. Mix Â½ cup soy sauce, Â¼ cup mirin, 2 tbsp sake in a zip-lock bag. Add peeled eggs. Marinate in the fridge minimum 4 hours, up to 24. The longer the better. Slice in half over rice â the yolk should be jammy and glossy. These make every weeknight better.",
    grad:"linear-gradient(135deg,#9fbfa8,#8aaa94)"
  },
  {
    ...
    source:"Adapted from NYT Cooking â David Tanis",
    components:["leeks","dijon vinaigrette","soft boiled egg + capers"],
    recipe:"Halve leeks lengthwise, wash thoroughly. Simmer in salted water 15 min until completely tender â they should be silky, not al dente. Drain and press gently. Make vinaigrette: 1 tbsp dijon, 1 tbsp red wine vinegar, 3 tbsp good olive oil, salt and pepper. Arrange leeks on a plate, spoon vinaigrette over. Top with roughly chopped soft boiled egg and capers. Serve warm or at room temperature as a starter or light lunch.",
    grad:"linear-gradient(135deg,#9b8ec4,#8070b0)"
  },
  {
    id:"i9", tag:"whoa factor", cuisine:"italian", time:20,
    name:"pasta aglio e olio",
    why:"the purest expression of italian cooking. garlic, olive oil, pasta water. the technique is everything â get the emulsion right and it's transcendent.",
    source:"Classic Neapolitan preparation",
    components:["spaghetti","garlic + good olive oil","chili flakes + parsley"],
    recipe:"Cook spaghetti. While it cooks, gently warm 6 thinly sliced garlic cloves in Â½ cup good olive oil over very low heat â you want them golden and sweet, not brown. Add a pinch of chili flakes. Add Â½ cup pasta water to the garlic oil and swirl. Drain pasta, add to pan, toss vigorously off heat adding more pasta water as needed until silky. Finish with flat leaf parsley. The pasta water emulsification is the technique. Use your best olive oil.",
    grad:"linear-gradient(135deg,#c9a87c,#b89068)"
  },
  {
    ...
    recipe:"Steam fish 8-10 min. Meanwhile, sautÃ© 1 tbsp rinsed fermented black beans with minced ginger and garlic in oil 1 min until fragrant. Add 2 tbsp soy sauce, 1 tbsp shaoxing wine, 1 tsp sugar, and a splash of water. Simmer 2 min. Pour sauce over fish, top with julienned scallion and ginger. Heat oil until smoking, pour sizzling over everything. The fermented black beans are available on Weee â they are the ingredient that makes this dish.",
    grad:"linear-gradient(135deg,#c09090,#a87878)"
  },
  {
    id:"i11", tag:"whoa factor", cuisine:"simple", time:5,
    name:"broken egg salad",
    why:"jammy eggs broken over dressed arugula. the runny yolk becomes part of the dressing. the simplest lunch that feels like it belongs in a paris cafÃ©.",
    source:"NYT Cooking inspiration",
    components:["jammy eggs","arugula + modena balsamic","fleur de sel + parmigiano"],
    recipe:"Soft boil eggs exactly 7 min, ice bath, peel. Dress arugula generously with good olive oil, Modena balsamic, and fleur de sel. Place eggs on top and break them open roughly with a fork â let the yolk run into the salad. Add parmigiano shavings. Eat immediately. This is lunch for you and Callan on a good day.",
    grad:"linear-gradient(135deg,#8fb5c4,#7aa0b0)"
  },
  {
    id:"i12", tag:"nyt adaptation", cuisine:"french", time:40,
    name:"slow roasted salmon",
    why:"the nyt version that changed how people cook salmon. low and slow gives you impossibly silky flesh â nothing like the pan-seared version. it looks underdone but it's perfect.",
    source:"Adapted from NYT Cooking",
    components:["salmon","good olive oil + lemon zest","fresh dill + fleur de sel"],
    recipe:"Bring salmon to room temperature. Rub generously with olive oil, lemon zest, salt, and pepper. Place on a foil-lined sheet pan. Roast at 275Â°F for 30-35 min â it will look barely cooked and almost translucent in the center. That is correct. The flesh should be silky and yield to a fork with almost no resistance. Finish with fresh dill and fleur de sel. Serve over arugula with Modena balsamic. This is a different dish than any salmon you've made before.",
    grad:"linear-gradient(135deg,#9fbfa8,#8aaa94)"
  },
];

// âââ BREAKFASTS âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ

const BREAKFASTS = [
  { id:"b1", name:"belgian boys pancakes", detail:"fresh fruit Â· whole milk", source:"costco", fav:true,
  ...
  { id:"b2", name:"noosa yogurt bowl", detail:"seasonal fruit Â· honey", source:"costco", fav:true,
    how:"Spoon Noosa into bowls. Top with whatever fruit you have. Drizzle with honey. Done in 2 minutes. Kids love this one." },
  { id:"b3", name:"steamed cantonese egg", detail:"sesame oil Â· soy sauce Â· fruit on the side", source:"gopuff + weee", fav:true,
    how:"Beat 2 eggs with 1.5x their volume in warm water plus a pinch of salt. Strain through a sieve. Steam covered on low-medium heat 8-10 min until just set â it should wobble slightly. Drizzle with soy sauce and sesame oil." },
  ...
  { id:"b5", name:"feta egg white omelet", detail:"cherry tomatoes Â· good coffee", source:"gopuff + freshdirect", fav:true,
  ...
  { id:"b6", name:"smoked salmon on sourdough", detail:"cream cheese Â· dried dill", source:"costco + city run", fav:true,
  ...
  { id:"b8", name:"miso butter toast", detail:"good bread Â· miso butter Â· honey", source:"weee + gopuff", fav:false,
    how:"Mix 1 tbsp softened butter with 1 tsp white miso until combined. Spread thickly on toast. Drizzle of honey on top. Takes 3 minutes and tastes like a Japanese breakfast cafÃ©." },
  { id:"b9", name:"soft boiled eggs on rice", detail:"soy Â· sesame oil Â· leftover rice", source:"gopuff + weee", fav:false,
  ...
  { id:"b10", name:"fruit + cheese plate", detail:"whatever looks good Â· cheddar or brie", source:"costco + freshdirect", fav:false,
  ...
  { id:"b11", name:"avocado toast with egg", detail:"sourdough Â· olive oil Â· fleur de sel", source:"freshdirect + gopuff", fav:false,
  ...
  { id:"b12", name:"congee", detail:"leftover rice Â· ginger Â· soy", source:"weee + gopuff", fav:false,
...
// âââ LUNCHES âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ

const LUNCHES = [
  { id:"l1", name:"genova tuna sandwich", detail:"jj casone bread Â· cheddar Â· mayo", source:"costco", fav:true,
    how:"Open the Genova tuna in olive oil â do not drain. Mix lightly with mayo. Layer on JJ Casone bread with cheddar. The olive oil from the can makes all the difference." },
  ...
  { id:"l3", name:"arugula salad", detail:"modena balsamic Â· good olive oil", source:"freshdirect", fav:true,
  ...
  { id:"l4", name:"leftover rice bowl", detail:"any protein Â· soy + sesame", source:"leftovers + weee", fav:true,
  ...
  { id:"l5", name:"soft scrambled egg toast", detail:"sourdough Â· scallion Â· fleur de sel", source:"gopuff + freshdirect", fav:true,
    how:"Melt butter in a non-stick pan on low. Add beaten eggs and stir constantly â you want them barely set and very creamy. Pull off heat while slightly wet. Pile onto toast, finish with fleur de sel and scallion." },
  { id:"l6", name:"broken egg salad", detail:"jammy eggs Â· arugula Â· modena balsamic", source:"freshdirect + gopuff", fav:false,
    how:"Soft boil eggs exactly 7 min. Dress arugula with olive oil, Modena balsamic, and fleur de sel. Place eggs on top and break them open â let the yolk run into the salad. Add parmigiano shavings. Eat immediately." },
  { id:"l7", name:"miso soup + rice", detail:"dashi Â· silken tofu Â· scallion", source:"weee", fav:false,
  ...
  { id:"l8", name:"smashed cucumber salad", detail:"soy Â· sesame Â· rice vinegar Â· chili", source:"weee + freshdirect", fav:false,
  ...
  { id:"l9", name:"smoked salmon rice bowl", detail:"leftover rice Â· cream cheese Â· dill", source:"costco", fav:false,
  ...
  { id:"l10", name:"simple tomato soup", detail:"canned tomatoes Â· good olive oil", source:"freshdirect", fav:false,
    how:"SautÃ© 2 garlic cloves in olive oil. Add one 28oz can of crushed tomatoes, salt, pinch of sugar. Simmer 15 min. Blend until smooth. Finish with good olive oil. Serve with JJ Casone bread." },
];

// âââ NYC FINDS ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ

const ALL_FINDS = [
  { tag:"italian",   name:"fresh burrata",        where:"Murray's Cheese Â· Bleecker St",    why:"one ingredient that turns a simple pasta night into something genuinely special.",              grad:"linear-gradient(135deg,#c9a87c,#b89068)" },
  { tag:"italian",   name:"san marzano tomatoes",  where:"Eataly Â· Flatiron",               why:"the pantry upgrade that makes every pasta sauce taste noticeably different.",                   grad:"linear-gradient(135deg,#c9a87c,#b89068)" },
  { tag:"italian",   name:"fresh pasta sheets",    where:"Eataly Â· Flatiron",               why:"fresh pasta takes a simple sauce and turns it into a weeknight that feels like a real dinner.", grad:"linear-gradient(135deg,#c9a87c,#b89068)" },
  { tag:"italian",   name:"nduja",                 where:"Eataly Â· Flatiron",               why:"spicy spreadable pork that melts into any pasta. a tiny amount goes a long way.",              grad:"linear-gradient(135deg,#c9a87c,#b89068)" },
  { tag:"japanese",  name:"dashi stock packets",   where:"Katagiri Â· East 59th St",         why:"unlocks oyakodon and cold soba in 20 min. the pantry staple that changes everything.",         grad:"linear-gradient(135deg,#9fbfa8,#8aaa94)" },
  { tag:"japanese",  name:"yuzu kosho",            where:"Katagiri Â· East 59th St",         why:"a tiny jar that adds instant brightness and heat to any fish or chicken.",                     grad:"linear-gradient(135deg,#9fbfa8,#8aaa94)" },
  ...
  { tag:"japanese",  name:"white miso",            where:"Katagiri Â· East 59th St",         why:"one tub unlocks miso glazed salmon, miso soup, miso butter pasta. incredibly versatile.",      grad:"linear-gradient(135deg,#9fbfa8,#8aaa94)" },
  { tag:"french",    name:"beurre de baratte",     where:"Eataly Â· Flatiron",               why:"french cultured butter. makes pan sauce chicken taste like a parisian bistro.",                 grad:"linear-gradient(135deg,#9b8ec4,#8070b0)" },
  { tag:"french",    name:"castelvetrano olives",  where:"Eataly or FreshDirect",           why:"buttery and mild â not briny. the olive that converts people who don't like olives.",           grad:"linear-gradient(135deg,#9b8ec4,#8070b0)" },
  ...
  { tag:"cantonese", name:"fresh silken tofu",     where:"Hong Kong Supermarket Â· Canal St",why:"silkier than anything delivered. elevates your steamed egg and tofu pork bowl entirely.",      grad:"linear-gradient(135deg,#c09090,#a87878)" },
  ...
  { tag:"cantonese", name:"fresh pea shoots",      where:"Hong Kong Supermarket Â· Canal St",why:"better than anything on freshdirect. flash-stir-fried with garlic they are perfect.",          grad:"linear-gradient(135deg,#c09090,#a87878)" },
  { tag:"cantonese", name:"roasted pork belly",    where:"Big Wing Wong Â· Mott St",         why:"slice over rice with soy sauce for the easiest great dinner. chinatown haul worth making.",    grad:"linear-gradient(135deg,#c09090,#a87878)" },
  { tag:"pantry",    name:"fleur de sel",          where:"Eataly Â· Flatiron",               why:"finishing salt on salmon, eggs, or pasta is the tiny upgrade that makes everything taste intentional.", grad:"linear-gradient(135deg,#8fb5c4,#7aa0b0)" },
  { tag:"pantry",    name:"good olive oil",        where:"Eataly Â· Flatiron",               why:"one bottle of genuinely good olive oil changes the flavor of everything you drizzle it on.",   grad:"linear-gradient(135deg,#8fb5c4,#7aa0b0)" },
  { tag:"pantry",    name:"modena balsamic",       where:"Eataly Â· Flatiron",               why:"real aged balsamic on arugula is in a completely different category than grocery store stuff.", grad:"linear-gradient(135deg,#8fb5c4,#7aa0b0)" },
  { tag:"city run",  name:"fu zhou we pork buns",  where:"Fu Zhou We Â· East Broadway",      why:"50-bun haul. straight to the freezer. the best breakfast investment you can make.",            grad:"linear-gradient(135deg,#c8b8a0,#b8a890)" },
  { tag:"city run",  name:"tai pan bakery",        where:"Tai Pan Bakery Â· Canal St",       why:"egg tarts and pineapple buns the kids will genuinely love. grab a dozen downtown.",            grad:"linear-gradient(135deg,#c8b8a0,#b8a890)" },
  { tag:"city run",  name:"tal's bagels",          where:"Tal Bagels Â· UES",                why:"two blocks away and worth it. the best easy saturday morning you can give your family.",        grad:"linear-gradient(135deg,#c8b8a0,#b8a890)" },
];

const NYC_FINDS_DEFAULT = [ALL_FINDS[0], ALL_FINDS[4], ALL_FINDS[8], ALL_FINDS[11]];

// âââ SHOPPING ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
const SVC_LABELS = { freshdirect:"freshdirect", costco:"costco Â· instacart", weee:"weee", gopuff:"gopuff" };
const SVC_HINTS  = { freshdirect:null, costco:"tap items to copy Â· search manually in instacart", weee:null, gopuff:"tap items to copy Â· search manually in gopuff" };
  ...
  return (
    <div style={{marginTop:16}} onClick={e=>e.stopPropagation()}>
      ...
      <textarea value={val} onChange={e=>setVal(e.target.value)}
        placeholder="add miso next time Â· double the shrimp Â· kids loved this"
        rows={2}
  ...
  return (
    <div className="p" onClick={handle}
      ...
      <div style={{display:"flex",alignItems:"center",gap:8,flexShrink:0,marginLeft:8}}>
        ...
        <span style={{fontSize:10,color:"rgba(0,0,0,.35)",letterSpacing:1.5,transition:"all .15s"}}>{copied?"â":"copy"}</span>
      </div>
    </div>
  );
}
      ...
      <div style={{padding:"20px 20px"}}>
        ...
        {open&&(
          <div style={{marginTop:16}}>
            ...
            <div style={{fontSize:12,color:"#aaa",marginBottom:14,lineHeight:1.7}}>{r.components.join(" Â· ")}</div>
            ...
            <div style={{marginTop:14,display:"flex",gap:8}}>
              {[["loved","â¥ loved"],["liked","â liked"],["skip","â skip"]].map(([rv,label])=>(
...
function SimplifyInput({ col }) {
  ...
  const simplify = () => {
    ...
    const isFrench=/french|bistro|beurre|confit|cassoulet|coq au vin|gratin|bouillabaisse|provenÃ§al|provencal/.test(input);
    const isItalian=/italian|pasta|risotto|gnocchi|carbonara|bolognese|ragÃ¹|ragu|pesto|arrabiata|amatriciana|cacio|aglio/.test(input);
    ...
    let s="";
    if(isMelon&&/bitter/.test(input)) s="bitter melon Â· stir-fried with minced pork, garlic, and oyster sauce Â· steamed rice. slice thin, salt and squeeze to draw out bitterness. one of the great cantonese weeknight dishes. 20 min.";
    else if(isRadish) s="watermelon radish Â· slice paper thin on a mandoline Â· dress with rice vinegar, sesame oil, and fleur de sel. the color is vivid, the crunch is everything. or quick-pickle in rice vinegar, sugar, and salt â keep a jar in the fridge all week. 5 min.";
    else if(isEggplant) s="eggplant Â· roasted whole until collapsed, then torn Â· dress with miso + sesame or olive oil + garlic + tomato. silky, smoky, almost no work. 30 min.";
    else if(isMushroom) s="mushrooms Â· seared hard in butter until golden, no stirring Â· finish with garlic, thyme, and a splash of white wine or soy. serve over rice, pasta, or toast. 15 min.";
    else if(isAsparagus) s="asparagus Â· roasted at 425Â°F with olive oil and salt Â· finish with lemon zest and parmigiano or a soft egg on top. 15 min.";
    else if(isBroccolini) s="broccolini Â· blanched 2 min then seared in a hot pan Â· finish with garlic, chili flakes, and olive oil or oyster sauce and sesame. 15 min.";
    else if(isPeaShoot) s="pea shoots Â· flash stir-fried in a very hot wok with garlic and a splash of shaoxing wine Â· salt and sesame oil to finish. one of the fastest great dishes you can make. 8 min.";
    else if(isCorn) s="corn Â· cut off the cob and seared in butter until charred Â· finish with miso butter or cotija + lime + chili. works as a side or tossed through pasta. 15 min.";
    else if(isBokChoy) s="bok choy Â· halved and seared cut-side down in sesame oil Â· add oyster sauce + a splash of water, cover 2 min Â· finish with garlic. 10 min.";
    else if(isLeek) s="leeks Â· slow-braised in butter until completely soft and sweet Â· finish with white wine, thyme, and a soft egg on top. incredible on toast. 25 min.";
    else if(isFennel) s="fennel Â· sliced thin and roasted until caramelized Â· dress with olive oil, lemon, and shaved parmigiano. or braise with white wine alongside fish. 30 min.";
    else if(isArugula) s="arugula Â· dressed with olive oil, modena balsamic, and fleur de sel Â· add parmigiano shavings and any leftover protein. or wilt briefly into hot pasta at the very end. 5 min.";
    else if(isCauliflower) s="cauliflower Â· roasted at 450Â°F until very dark and caramelized Â· finish with tahini + lemon or curry butter. transforms completely with high heat. 30 min.";
    else if(isKale) s="kale Â· massaged with olive oil and lemon until soft Â· toss with parmigiano and toasted breadcrumbs. or wilt into pasta with sausage. 10 min.";
    else if(isTomato) s="tomatoes Â· roasted slowly at 300Â°F with olive oil, garlic, and thyme until concentrated Â· toss through pasta or serve with burrata and good bread. 45 min hands-off, 10 min active.";
    else if(isZucchini) s="zucchini Â· sliced thin and fried in olive oil until golden Â· layer with torn basil, garlic, and parmigiano. the neapolitan way. 20 min.";
    else if(isSquash) s="kabocha or butternut Â· microwave whole 4 min to soften, then cut and roast chunks at 425Â°F Â· finish with miso butter or brown butter and sage. 35 min.";
    else if(isPotato) s="potatoes Â· sliced and roasted at 425Â°F with olive oil, garlic, and rosemary until crispy Â· or boiled and crushed with butter and chives. 35 min.";
    else if(isCabbage) s="napa cabbage Â· stir-fried with garlic, ginger, and oyster sauce Â· or braised slowly until silky with pork belly. one of the most underrated weeknight vegetables. 15 min.";
    else if(hasEgg&&hasSoy) s="soy-marinated eggs Â· steamed rice Â· sautÃ©ed pea shoots with garlic. make the eggs the night before â soak in soy, mirin, and sake for at least 4 hours. 20 min active.";
    else if(hasEgg&&hasMiso) s="soft scrambled eggs Â· miso butter on toast Â· sliced scallion and sesame oil. miso into your butter before scrambling. 10 min.";
    else if(hasEgg&&isAsian) s="steamed cantonese egg Â· soy sauce + sesame oil Â· jasmine rice. beat eggs with 1.5x volume warm water, strain, steam 8-10 min. 15 min.";
    else if(hasRamen&&hasMiso) s="fresh ramen noodles from weee Â· miso broth (miso + dashi + hot water) Â· soft boiled egg + scallion. 20 min.";
    else if(hasRamen) s="ramen noodles Â· store-bought broth + miso or soy Â· soft boiled egg + whatever protein you have. 20 min.";
    else if(hasCurry&&isAsian) s="japanese curry roux from weee Â· chicken thigh + potato + kabocha Â· steamed jasmine rice. the box does the work. 35 min.";
    else if(hasDumpling) s="store-bought dumplings (weee or freezer) Â· chili oil + black vinegar dipping sauce Â· simple cucumber salad. 15 min.";
    else if(hasMiso&&isFish) s="fish fillet Â· white miso + mirin + honey glaze Â· steamed bok choy. pat completely dry, marinate 15-20 min, broil on high 8-10 min. 25 min.";
    else if(hasMiso&&isChicken) s="chicken thighs Â· white miso + sake + mirin glaze Â· jasmine rice. broil until deeply caramelized. 25 min.";
    else if(hasMiso) s="your protein Â· white miso + mirin + touch of honey glaze Â· one green vegetable. miso is the sauce. 20-25 min.";
    else if(hasSoy&&isFish) s="steamed or pan-seared fish Â· soy + sesame + ginger sauce Â· jasmine rice. pour the hot sauce over at the end. 20 min.";
    else if(hasSoy&&isPork) s="pork belly or tenderloin Â· soy + mirin + sake glaze Â· steamed rice + pea shoots. 30 min.";
    else if(hasSoy&&isChicken) s="chicken thighs Â· soy + mirin + ginger Â· jasmine rice. marinate briefly, cook in the sauce. 25 min.";
    else if(hasSoy) s="your protein Â· soy + sesame oil + ginger sauce Â· jasmine rice or noodles. 20 min.";
    else if(isFrench&&isChicken) s="seared chicken thighs Â· shallot + white wine pan sauce Â· haricots verts. deglaze the pan after searing â the fond is the sauce. 35 min.";
    else if(isFrench&&isFish) s="pan-seared fish fillet Â· herb butter sauce (butter + tarragon + lemon) Â· roasted asparagus. 20 min.";
    else if(isFrench&&isMussel) s="mussels Â· white wine + shallot + butter broth Â· crusty bread. 20 min.";
    else if(isFrench) s="your protein Â· shallot + white wine + cold butter pan sauce Â· one simple vegetable. 30 min.";
    else if(isItalian&&isShrimp) s="linguine Â· shrimp + garlic + miso + olive oil Â· parsley and parm. 20 min.";
    else if(isItalian&&isPork) s="orecchiette Â· italian sausage + kale + parmigiano Â· olive oil. 30 min.";
    else if(isItalian) s="pasta Â· one good sauce Â· parmigiano + fresh basil. 20 min.";
    else if(isFish) s="pan-seared or broiled fish fillet Â· miso glaze or herb butter Â· one roasted vegetable. 20 min.";
    else if(isShrimp) s="shrimp Â· garlic + butter + white miso or soy + sesame Â· pasta or rice. 15 min.";
    else if(isScallop) s="seared scallops Â· brown butter + lemon + capers Â· simple green vegetable. pat completely dry before searing â essential. 15 min.";
    else if(isChicken) s="chicken thighs Â· one good sauce or glaze Â· simple vegetable or grain. 30 min.";
    else if(isPork) s="pork tenderloin Â· soy + mirin glaze or pan sauce Â· steamed rice + pea shoots. 30 min.";
    else if(isBeef) s="seared steak or short rib Â· pan sauce or soy glaze Â· roasted vegetable or rice. 30 min.";
    else if(isTofu) s="silken tofu Â· soy + sesame oil + ginger + scallion Â· steamed rice. pour hot oil over at the end. 15 min.";
    else s="keep the hero ingredient Â· pick one sauce or seasoning you already have Â· pair with rice, pasta, or one vegetable. goal: 3 components, 25 min.";
  ...
  return (
    <div style={{marginTop:24,background:"#0e0e0e",borderRadius:20,padding:"20px 20px"}} onClick={e=>e.stopPropagation()}>
      ...
      <div style={{fontSize:13,color:"#777",marginBottom:12,lineHeight:1.5}}>one ingredient, a dish you saw, or something you ate â get a simple version.</div>
      <textarea value={val} onChange={e=>setVal(e.target.value)}
        placeholder="e.g. bitter melon Â· watermelon radish Â· miso ramen from ippudo"
        rows={2}
        style={{width:"100%",background:"#1a1a1a",border:"1px solid #2a2a2a",borderRadius:10,
          padding:"10px 12px",fontSize:12,color:"#ccc",resize:"none",fontFamily:"inherit",
      ...
      <div style={{padding:"28px 22px 110px"}}>
        ...
        {st.tab==="today"&&(
          <div>
            <div className="p u" onClick={!gen?generate:undefined}
              ...
              {T(gen?"finding the right mealsâ¦":st.weekPlan?"ready to mix it up?":"let's plan your week.",{color:gen?"#666":"rgba(0,0,0,.4)"})}
              ...
              {!gen&&<div style={{marginTop:20,width:40,height:40,borderRadius:50,background:"rgba(0,0,0,.15)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:20,color:"rgba(0,0,0,.5)"}}>â¦</div>}
            </div>
                    ...
                    <div style={{padding:"20px 20px 18px"}}>
                      ...
                      {isExp&&(
                        <div style={{marginTop:14}}>
                          <div style={{fontSize:12,color:"#aaa",marginBottom:16,lineHeight:1.7,letterSpacing:.3}}>{full.components.join(" Â· ")}</div>
                          <div style={{fontSize:10,letterSpacing:2,color:col,marginBottom:10}}>how to make it</div>
                          ...
                          <div style={{display:"flex",gap:8,marginBottom:0}}>
                            {[["loved","â¥ loved"],["liked","â liked"],["skip","â skip"]].map(([r,label])=>(
        ...
        {st.tab==="shop"&&(
          <div>
            ...
            {!st.weekPlan&&<div style={{fontSize:15,fontWeight:200,color:"#888",lineHeight:1.6}}>generate a plan first â<br/>your list will appear here.</div>}
                      ...
                      {items.map(({i:itemName,q:qty},ii)=>{
                        ...
                        return hasSearch?(
                          <a key={ii} href={searchUrl(svc,itemName)} target="_blank" rel="noreferrer"
                            ...
                            <span style={{fontSize:14,fontWeight:300,color:"rgba(0,0,0,.8)",textTransform:"lowercase"}}>{itemName}</span>
                            <span style={{fontSize:11,color:"rgba(0,0,0,.45)",marginLeft:8,flexShrink:0,letterSpacing:.5}}>{qty} &thinsp;â</span>
                          </a>
                        ):(
            ...
            {st.weekPlan&&(
              <div className="p u" onClick={()=>{try{const all=Object.entries(st.weekPlan.shopping).filter(([,v])=>v?.length).map(([k,v])=>`${SVC_LABELS[k].toUpperCase()}\n${v.map(({i,q})=>`â¢ ${i} â ${q}`).join("\n")}`).join("\n\n");navigator.clipboard.writeText(all);}catch(e){}}}
                ...
                <div>
                  ...
                  <div style={{fontSize:11,color:"#777",marginTop:3}}>all stores Â· paste anywhere</div>
                </div>
                <div style={{fontSize:20,color:"#777"}}>â</div>
              </div>
            )}
            <div className="u" style={{marginTop:4,background:"#0e0e0e",borderRadius:20,padding:"22px"}}>
              {T("city runs Â· as needed",{letterSpacing:3,marginBottom:16})}
              {[{name:"fu zhou we Â· 50 bun haul",note:"when freezer runs low",url:"https://maps.google.com/?q=Fu+Zhou+We+Chinatown+Manhattan"},
        ...
        {st.tab==="inspire"&&(
          <div>
            ...
            <div style={{fontSize:14,fontWeight:200,color:"#888",marginBottom:24,lineHeight:1.6}}>
              adaptations worth making. nyt recipes, classics, and a few discoveries â all stripped to their weeknight essence.
            </div>
        ...
        {st.tab==="finds"&&(
          <div>
            ...
            <div className="p u" onClick={!aiL?getFinds:undefined}
              ...
              <span style={{fontSize:12,letterSpacing:2,color:"#e8e6e0"}}>{aiL?"finding good spotsâ¦":"refresh finds"}</span>
              <span style={{fontSize:14,color:"#666"}}>â»</span>
            </div>
            ...
            {(ai&&typeof ai==="object"&&ai.finds?ai.finds:NYC_FINDS_DEFAULT).map((find,i)=>(
              <div key={i} className={`u d${Math.min(i+1,5)}`} style={{marginBottom:10}}>
                <div style={{background:find.grad,borderRadius:24,padding:"24px 22px"}}>
                  ...
                  <div style={{fontSize:11,color:"rgba(0,0,0,.55)",marginBottom:12}}>ð {find.where}</div>
            ...
            {HITS.map((meal,i)=>{
              ...
              return (
                <div key={meal.id} className={`u d${Math.min(i+1,5)}`}
                  ...
                  <div style={{fontSize:11,color:"#888",marginBottom:12,lineHeight:1.6}}>{meal.cuisine} Â· {meal.time} min</div>
                  <div style={{display:"flex",gap:8}}>
                    {[["loved","â¥ loved"],["liked","â liked"],["skip","â skip"]].map(([r,label])=>(
            ...
            {NEW_MEALS.map((meal,i)=>{
              ...
              return (
                <div key={meal.id} className={`u d${Math.min(i+1,5)}`}
                  ...
                  <div style={{fontSize:11,color:"#888",marginBottom:12,lineHeight:1.6}}>{meal.cuisine} Â· {meal.time} min Â· {meal.components.join(", ")}</div>
                  <div style={{display:"flex",gap:8}}>
                    {[["loved","â¥ loved"],["liked","â liked"],["skip","â skip"]].map(([r,label])=>(
                      <div key={r} className="p" onClick={()=>rate(meal.id,r)}
                        style={{flex:1,padding:"8px 0",textAlign:"center",borderRadius:50,fontSize:11,letterSpacing:.5,transition:"all .15s",
            ...
            {INSPIRATION.map((r,i)=>{
              ...
              return (
                <div key={r.id} className={`u d${Math.min(i+1,5)}`}
                  ...
                  <div style={{fontSize:11,color:"#888",marginBottom:12}}>{r.cuisine} Â· {r.time} min Â· {r.tag}</div>
                  <div style={{display:"flex",gap:8}}>
                    {[["loved","â¥ loved"],["liked","â liked"],["skip","â skip"]].map(([rv,label])=>(
